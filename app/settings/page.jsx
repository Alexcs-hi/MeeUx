    ...
    <div className="p-4 flex  flex-col gap-4 w-full lg:w-1/2 md:w-2/3 mx-auto" >
      <div className=" border-gray-300/20 border rounded p-4 flex flex-col gap-4 ">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <button className="cursor-pointer p-2 border-gray-200/20 rounded border hover:bg-gray-200/50 transition">Dark</button>
          <button className="cursor-pointer p-2 border-gray-200/20 rounded border hover:bg-gray-200/50 transition">Light</button>
        </div>
      </div>
      ...
      <div className=" border-gray-300/20 border rounded p-4 flex flex-col gap-4 ">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <button className="cursor-pointer p-2 border-gray-200/20 rounded border hover:bg-gray-200/50 transition">Submit</button>
        </div>
      ...
      <h1>Note: This is a work in progress page none of the featurs work as of now </h1>
    </div>
  )
}
