    ...
    <div className='p-4 flex  flex-col gap-4 w-full lg:w-1/2 md:w-2/3 mx-auto'>
      <div className=' border-gray-300/20 bg-gray-600/20 border rounded-md p-4 flex flex-col gap-4 '>
        ...
        <div className='flex items-center gap-4 flex-wrap'>
          ...
          <button className='cursor-pointer p-2 border-gray-200/20 rounded border hover:bg-gray-200/20 transition'>
            Dark
          </button>
          <button className='cursor-pointer p-2 border-gray-200/20 rounded border hover:bg-gray-200/20 transition'>
            Light
      ...
      <div className=' border-gray-300/20 bg-gray-600/20 border rounded-md p-4 flex flex-col gap-4 '>
        ...
        <p className='text-gray-400 text-sm italic truncate'>
          Example :
          &user_id=3854015&api_key=2266c0a9205c124f0bc781ce80735efdf671883bd25f944ff5903cb48fbff25ea7e71fc77e97b77f8c886505803a59904ecd0c3836605dada8d82530f6ee28a1
        </p>
      </div>
