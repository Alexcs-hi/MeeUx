  ...
  function NavButton({ name, route, image_src }) {
    return (
      <button
        ...
        className=' flex-none  relative  active:scale-95 flex flex-col items-center  group  cursor-pointer p-2  rounded-xl hover:bg-gray-200/20 transition'>
    ...
    return (
      <div
        ...
        <button
          ...
          <img className='h-7 w-7 invert' src='/cat_paw.png' alt='cat_paw' />
        </button>

        <button
          onClick={toggleSideBar}
          className='hover:bg-gray-200/20 rounded-xl p-2 cursor-pointer active:scale-95 focus:bg-gray-600/30 transition'>
          <img className='h-7 w-7 invert' src='/search.png' alt='search' />
        </button>

        <button
          onClick={() => router.push("/favorites")}
          className='hover:bg-gray-200/20 rounded-xl p-2 cursor-pointer  active:scale-95 focus:bg-gray-600/30 transition'>
          <img className='h-7 w-7 invert' src='/heart.png' alt='favorites' />
        </button>

        <button
          onClick={() => router.push("/about")}
          className='hover:bg-gray-200/20 rounded-md p-2 cursor-pointer active:scale-95 focus:bg-gray-600/30 transition'>
          <img className='h-7 w-7 invert' src='/about.png' alt='about' />
        </button>
      </div>
    );
  }
  ...
  return (
    <div
      ...
      <div className='flex-1 flex justify-start'>
        <button
          className=' cursor-pointer transition rounded-full p-2 hover:bg-gray-200/20   active:scale-95    '
      ...
      <div className='flex flex-1 justify-end gap-2'>
        <div className='flex gap-4 overflow-visible border-gray-600/20 rounded-xl p-2 border bg-gray-600/20     '>
          <button
            onClick={toggleSideBar}
            className='flex-none rounded-xl hover:bg-gray-200/20 p-2 active:scale-95 transition relative flex flex-col items-center cursor-pointer group'>
            <h1
              className={`opacity-0 absolute -bottom-8  group-hover:opacity-100 transition text-xs bg-gray-200/20 p-1 rounded `}>
              Search
            </h1>
