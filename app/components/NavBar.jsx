...
export default function NavBar() {
    ...
    return (
        <div className=" z-1 sticky top-0 bg-black/50 backdrop-blur-2xl flex justify-between items-center p-2 lg:pl-20 lg:pr-20 border-b border-gray-400/30 mb-10  " >
            ...
            <div className="flex items-center gap-3 lg:gap-10 md:gap-7 shrink-0">
                <button className=" cursor-pointer transition rounded-full p-2 hover:bg-gray-200/20" onClick={toggleSideBar}><img className="w-6 md:w-6 lg:w-7 invert" src="/search.png" alt="search_btn" /></button>
                <button className=" cursor-pointer transition rounded-full p-2 hover:bg-gray-200/20" onClick={() => window.open("https://github.com/Alexcs-hi")} ><img className="w-6 md:w-7 lg:w-8 invert" src="/github.png" alt="github_icon" /></button>
            </div>
